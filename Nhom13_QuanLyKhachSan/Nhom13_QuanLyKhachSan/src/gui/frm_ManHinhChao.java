...
public class frm_ManHinhChao extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		lblIcon.setIcon(new javax.swing.ImageIcon(
				"HinhAnh/icon-enterprise.png")); // NOI18N
		getContentPane().add(lblIcon);
		lblIcon.setBounds(0, 0, 310, 160);

		pnlTieuDe.setBackground(new java.awt.Color(0, 102, 255));

		lblTieuDe.setFont(new java.awt.Font("Tahoma", 1, 46)); // NOI18N
		lblTieuDe.setForeground(new java.awt.Color(255, 255, 255));
		lblTieuDe.setText("Khách sạn Triple T");

		lbl_TieuDe0.setFont(new java.awt.Font("Tahoma", 0, 23)); // NOI18N
		...
		pnlTieuDeLayout
				.setHorizontalGroup(pnlTieuDeLayout
						.createParallelGroup(
						...
						.addGroup(
								...
								pnlTieuDeLayout
										...
										.addContainerGap()));
		pnlTieuDeLayout
				.setVerticalGroup(pnlTieuDeLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
		...
		lblAnhNen.setIcon(new javax.swing.ImageIcon("HinhAnh/AnhNen.jpg")); // NOI18N
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(frm_ManHinhChao.class.getName())
