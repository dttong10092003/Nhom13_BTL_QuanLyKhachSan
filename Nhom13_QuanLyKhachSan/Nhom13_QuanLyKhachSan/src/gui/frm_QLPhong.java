...
public class frm_QLPhong extends javax.swing.JFrame {
	...
	// ImageIcon icon1 = new
	// ImageIcon(image.getScaledInstance(lbl_Anh2.getWidth(),
	// lbl_Anh2.getHeight(), image.SCALE_SMOOTH));
...
//		pnl_Hinh = new javax.swing.JPanel();
		...
		javax.swing.GroupLayout pnl_TieuDeLayout = new javax.swing.GroupLayout(
				pnl_TieuDe);
		pnl_TieuDe.setLayout(pnl_TieuDeLayout);
		pnl_TieuDeLayout.setHorizontalGroup(pnl_TieuDeLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						pnl_TieuDeLayout.createSequentialGroup()
								.addContainerGap(396, Short.MAX_VALUE)
								.addComponent(lbl_TieuDe).addGap(322, 322, 322)
								.addComponent(btn_Exit)));
		pnl_TieuDeLayout
				.setVerticalGroup(pnl_TieuDeLayout
						.createParallelGroup(
		...
		pnl_Phong.setBorder(new javax.swing.border.SoftBevelBorder(
...
//		pnl_Hinh.setBackground(new java.awt.Color(255, 255, 255));
		...
		lbl_Anh2.setBorder(javax.swing.BorderFactory
...
//		pnl_Hinh.setBounds(13, 339, 168, 224);
		...
		tbl_Phong.setModel(new javax.swing.table.DefaultTableModel(
				...
				}, new String[] { "Mã phòng", "LP", "Diện tích", "Hình",
						"Tình trạng", "Tầng" }));
		...
		layout.setHorizontalGroup(layout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(pnl_TieuDe, javax.swing.GroupLayout.DEFAULT_SIZE,
	...
	private void dienTTVaoTextField(String MaPhong) {
		...
		try {
			if (rs.next()) {
				...
				// ImageIcon(imageName).getImage().getScaledInstance(lbl_Anh2.getWidth(),
				// lbl_Anh2.getHeight(), Image.SCALE_SMOOTH));
				// lbl_Anh2.setIcon(ii);
				// lbl_ImageNV(imageName);
				String MaLoaiPhong = rs.getString("MaLoaiPhong");
				DefaultComboBoxModel cbbModel = (DefaultComboBoxModel) cbb_LoaiPhong
						.getModel();
	...
	private void lbl_Anh2MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_lbl_Anh2MouseClicked
		...
		if (resuft == JFileChooser.APPROVE_OPTION) {
			...
			ImageIcon ii = new ImageIcon(new ImageIcon(imageName).getImage()
					.getScaledInstance(lbl_Anh2.getWidth(),
							lbl_Anh2.getHeight(), Image.SCALE_SMOOTH));
			lbl_Anh2.setIcon(ii);
			imageName = f.getName();
		}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(frm_QLPhong.class.getName())
